...
def parse_args():
    ...
    parser.add_argument("-r", "--restrict", help="Restrict an interface from being used. Example: -r wlan0")
...
if __name__ == "__main__": 
    ...
    clients_APs = [] # Clients Dictionary
    APs = [] # AccessPoin Dictionary
